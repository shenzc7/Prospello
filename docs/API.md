# OKR Builder API Documentation

## Overview

This document describes the REST API endpoints for the OKR Builder OKR management system. All API endpoints require authentication via NextAuth.js session cookies.
